...
### **[Step 2.4] Summarise the data** {.unnumbered}
...
Choose [**TWO**]{.underline} variables that you think might predict airbnb prices. Briefly explain why you chose those two variables in your report, using your summary analysis above to justify your choice.
...
Compare your two models in terms of:
...
These instructions and the code will be released this evening.
